...
from src.strategies.leveraged import (
    ...
    DailyTrend3xDrawdownBoostStrategy,
    DailyTrend3xDefensiveStrategy,
    DailyTrend3xDefensiveV2Strategy,
    DcaLeverageBoostStrategy,
    DualMaLeverageLadderStrategy,
    Ema5TqqqTrendStrategy,
    LeveragedMomentumRotation3xStrategy,
    MomentumRotation2xStrategy,
    TqqqBullBearFullThrottleStrategy,
    TurboMomentum3xStrategy,
...
STRATEGY_TYPES = {
    ...
    "daily_trend_3x_drawdown_boost": DailyTrend3xDrawdownBoostStrategy,
    "daily_trend_3x_defensive_v2": DailyTrend3xDefensiveV2Strategy,
    "ema5_tqqq_trend": Ema5TqqqTrendStrategy,
    ...
    "leveraged_momentum_rotation_3x": LeveragedMomentumRotation3xStrategy,
    "tqqq_bull_bear_full_throttle": TqqqBullBearFullThrottleStrategy,
    "turbo_momentum_3x": TurboMomentum3xStrategy,
